...
Route::prefix('admin')->name('admin.')->group(function() {
    ...
    Route::middleware(['auth:web'])->group(function() {
        ...
        Route::prefix('purchaseorder')->name('purchaseorder.')->group(function () {
            ...
            Route::get('/{id}/viewstocks', 'Admin\PurchaseOrderController@viewstocks')->name('viewstocks');
            Route::get('/{id}/archivedBoxes', 'Admin\PurchaseOrderController@archivedBoxes')->name('archivedBoxes');
            ...
            Route::get('/{id}/viewGrn','Admin\PurchaseOrderController@viewGrn')->name('viewGrn');
        ...
        Route::get('/store-notes', 'Admin\AdminController@store_notes')->name('store-notes');
        Route::get('/travel-report', 'Admin\AdminController@travel_report')->name('travel-report');
        ...
        Route::prefix('accounting')->name('accounting.')->group(function(){
            ...
            Route::get('/edit_expenses/{id}', 'Admin\AccountingController@edit_expenses')->name('edit_expenses');
            Route::post('/update_expense/{id}', 'Admin\AccountingController@update_expense')->name('update_expense');
