            ...
            <table class="table table-sm table-hover ledger">
                ...
                <tbody id="ledger_body">
                    ...
                    <tr class="store_details_row">
                        ...
                        <td>
                            @if (!empty($item->payment_id) && ($item->purpose == 'expense'))
                                <a href="{{ route('admin.accounting.edit_expenses',$item->payment_id) }}" class="btn btn-outline-success select-md">Edit</a>
                            @endif
                        </td>
                    </tr>
                    <tr>
                    ...
                    @if(!empty($data))
                    <tr class="table-info">
                        <td colspan="7"><strong>Closing Amount</strong>  </td>
                        <td>                            
                            <strong>                                                               
...
<script>
    ...
    function downloadLedger(e){        
        ...
        var dataString = "from_date="+from_date+"&to_date="+to_date+"&user_type="+user_type+"&staff_id="+staff_id+"&store_id="+store_id+"&admin_id="+admin_id+"&supplier_id="+supplier_id+"&select_user_name="+select_user_name+"&sort_by="+sort_by+"&bank_cash="+bank_cash ;
        if(e == 'pdf'){
